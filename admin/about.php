	...
	<div class="feature-section col two-col">
		<div>
			...
			<p><?php
				...
				$string = __( 'Right now, SlioPress %1$s is already translated into %2$s languages, with more always in progress. You can switch to any translation on the <a href="%3$s">General Settings</a> screen.' );
...
<div class="changelog feature-list">
	...
	<div class="feature-section col two-col">
		...
		<div class="last-feature">
			...
			?></h4>
			<p><?php
				printf( __( '%s tells SlioPress to handle the complexities of document titles.' ), "<code>add_theme_support( 'title-tag' )</code>" );
			?></p>
...
/* translators: 1: SlioPress version number. */
_n_noop( '<strong>Version %1$s</strong> addressed a security issue.',
         '<strong>Version %1$s</strong> addressed some security issues.' );

/* translators: 1: SlioPress version number, 2: plural number of bugs. */
_n_noop( '<strong>Version %1$s</strong> addressed %2$s bug.',
         '<strong>Version %1$s</strong> addressed %2$s bugs.' );

/* translators: 1: SlioPress version number, 2: plural number of bugs. Singular security issue. */
_n_noop( '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bug.',
         '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bugs.' );

/* translators: 1: SlioPress version number, 2: plural number of bugs. More than one security issue. */
