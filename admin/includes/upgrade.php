...
function make_site_theme_from_oldschool($theme_name, $template) {
	 ...
	 */
	$files = array('index.php' => 'index.php', 'layout.css' => 'style.css', 'comments.php' => 'comments.php', 'comments-popup.php' => 'comments-popup.php');
	...
	foreach ($files as $oldfile => $newfile) {
		...
		if ($lines) {
			...
			foreach ($lines as $line) {
				if (preg_match('/require.*blog-header/', $line))
					$line = '//' . $line;

				// Update stylesheet references.
				$line = str_replace("<?php echo __get_option('siteurl'); ?>/layout.css", "<?php bloginfo('stylesheet_url'); ?>", $line);

				// Update comments template inclusion.
				$line = str_replace("<?php include(ABSPATH . 'comments.php'); ?>", "<?php comments_template(); ?>", $line);
...
function make_site_theme() {
	...
	if (file_exists(ABSPATH . 'layout.css')) {
