...
function install_search_form( $type_selector = true ) {
	...
	if ( ! $type_selector ) {
		$input_attrs = 'class="filter-search" placeholder="' . esc_attr__( 'Search Plugins' ) . '" ';
	}
...
<div class="upload-plugin">
	...
	<form method="post" enctype="multipart/form-data" class="upload-form" action="<?php echo self_admin_url('update.php?action=upload-plugin'); ?>">
