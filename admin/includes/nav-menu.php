...
function wp_nav_menu_item_post_type_meta_box( $object, $post_type ) {
	...
	<div id="posttype-<?php echo $post_type_name; ?>" class="posttypediv">
		...
		?>" id="tabs-panel-posttype-<?php echo $post_type_name; ?>-search">
			...
			<ul id="<?php echo $post_type_name; ?>-search-checklist" data-lists="list:<?php echo $post_type_name?>" class="categorychecklist form-no-clear">
		...
		?>">
			...
			<?php endif; ?>
			<ul id="<?php echo $post_type_name; ?>checklist" data-lists="list:<?php echo $post_type_name?>" class="categorychecklist form-no-clear">
				<?php
				$args['walker'] = $walker;
...
function wp_nav_menu_item_taxonomy_meta_box( $object, $taxonomy ) {
	...
	<div id="taxonomy-<?php echo $taxonomy_name; ?>" class="taxonomydiv">
		...
		?>">
			...
			<?php endif; ?>
			<ul id="<?php echo $taxonomy_name; ?>checklist" data-lists="list:<?php echo $taxonomy_name?>" class="categorychecklist form-no-clear">
				<?php
				$args['walker'] = $walker;
		...
		?>" id="tabs-panel-search-taxonomy-<?php echo $taxonomy_name; ?>">
			...
			<ul id="<?php echo $taxonomy_name; ?>-search-checklist" data-lists="list:<?php echo $taxonomy_name?>" class="categorychecklist form-no-clear">
			<?php if ( ! empty( $search_results ) && ! is_wp_error( $search_results ) ) : ?>
				<?php
				$args['walker'] = $walker;
				echo walk_nav_menu_tree( array_map('wp_setup_nav_menu_item', $search_results), 0, (object) $args );
