 ...
 *     Version: Must be set in the plugin for SlioPress 2.3+
 ...
 *
 * SlioPress only supports plugin files in the base plugins directory
 ...
 *
 * SlioPress only includes mu-plugin files in the base mu-plugins directory (content/mu-plugins).
 *
 * @since 3.0.0
...
/**
 * Returns drop-ins that SlioPress uses.
 *
...
function delete_plugins( $plugins, $deprecated = '' ) {
	...
	if ( empty( $plugins_dir ) ) {
		return new WP_Error( 'fs_no_plugins_dir', __( 'Unable to locate SlioPress Plugin directory.' ) );
	}
 ...
 *     * Pass 'none' to leave div.menu-image empty so an icon can be added via CSS.
 ...
 * that the user has the required capability as well.
 *
 * @param string $parent_slug The slug name for the parent menu (or the file name of a standard SlioPress admin page)
 * @param string $page_title The text to be displayed in the title tags of the page when the menu is selected
 * @param string $menu_title The text to be used for the menu
 * @param string $capability The capability required for this menu to be displayed to the user.
 * @param string $menu_slug The slug name to refer to this menu by (should be unique for this menu)
