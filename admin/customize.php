...
$body_class = 'core-ui customizer js';
...
<div class="full-overlay expanded">
	<form id="customize-controls" class="wrap full-overlay-sidebar">
		...
		<div id="customize-header-actions" class="full-overlay-header">
			<?php
		...
		<div id="customize-footer-actions" class="full-overlay-footer">
	...
	<div id="customize-preview" class="full-overlay-main"></div>
	<?php
