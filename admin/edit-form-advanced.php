...
?>
<div id="postdivrich" class="postarea<?php if ( $_wp_editor_expand ) { echo ' editor-expand'; } ?>">
...
<table id="post-status-info"><tbody><tr>
	<td id="word-count"><?php printf( __( 'Word count: %s' ), '<span class="word-count">0</span>' ); ?></td>
