...
?>
	...
	jQuery(document).ready(function($) {
		...
		if ( $( '#content-wrap' ).hasClass( 'html-active' ) && window.switchEditors &&
...
?>
<body class="press-this admin core-ui <?php echo $admin_body_class; ?>">
				...
				<div id="taxonomy-category" class="categorydiv">
					...
					<?php if ( current_user_can($tax->cap->edit_terms) ) : ?>
						<div id="category-adder" class="hidden-children">
							...
							<p id="category-add" class="category-add hidden-child">
								...
								<input type="button" id="category-add-submit" data-lists="add:categorychecklist:category-add" class="button category-add-submit" value="<?php echo esc_attr( $tax->labels->add_new_item ); ?>" />
