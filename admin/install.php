...
if ( ! is_string( $wpdb->base_prefix ) || '' === $wpdb->base_prefix ) {
	display_header();
	die( '<h1>' . __( 'Configuration Error' ) . '</h1><p>' . __( 'Your <code>config.php</code> file has an empty database table prefix, which is not supported.' ) . '</p></body></html>' );
}
...
<p class="step"><a href="../login.php" class="button button-large"><?php _e( 'Log In' ); ?></a></p>
