...
if ( isset( $_POST['deletepost'] ) )
	$action = 'delete';
elseif ( isset($_POST['preview']) && 'dopreview' == $_POST['preview'] )
	$action = 'preview';
...
case 'editpost':
	...
	if ( isset( $_COOKIE['saving-post'] ) && $_COOKIE['saving-post'] === $post_id . '-check' ) {
		setcookie( 'saving-post', $post_id . '-saved', time() + DAY_IN_SECONDS );
	}
