	...
	$( function() {
		...
		$document.on( 'tinymce-editor-init.editor-expand', function( event, editor ) {
			...
			mceBind = function() {
				...
				editor.on( 'toolbar-toggle', toggleAdvanced );
				// Adjust when the editor resizes.
				editor.on( 'setcontent autoresize toolbar-toggle', adjust );
			...
			mceUnbind = function() {
				...
				editor.off( 'toolbar-toggle', toggleAdvanced );
				editor.off( 'setcontent autoresize toolbar-toggle', adjust );
		...
		function adjust( event ) {
			...
			if ( ! canPin ) {
				...
				if ( ( ! fixedBottom || ( resize && advanced ) ) &&
						// +[n] for the border around the .editor-container.
		...
		function on() {
			...
			$document.on( 'collapse-menu.editor-expand postboxes-columnchange.editor-expand editor-classchange.editor-expand', adjust )
				.on( 'postbox-toggled.editor-expand', function() {
					...
					adjust();
				}).on( 'window-resized.editor-expand', function() {
		...
		$document.on( 'tinymce-editor-init.focus', function( event, editor ) {
			...
			if ( editor.id === 'content' ) {
				...
				mceBind = function() {
					...
					editor.on( 'blur', blur );
					editor.on( 'autoresize', recalcEditorRect );
				};
				...
				mceUnbind = function() {
					...
					editor.off( 'autoresize', recalcEditorRect );
				};
