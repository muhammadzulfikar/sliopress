...
if ( file_exists( ABSPATH . 'config.php' ) )
	wp_die( '<p>' . sprintf( __( "The file 'config.php' already exists. If you need to reset any of the configuration items in this file, please delete it first. You may try <a href='%s'>installing now</a>." ), 'install.php' ) . '</p>' );
...
<p>
	...
	<strong><?php _e( "If for any reason this automatic file creation doesn&#8217;t work, don&#8217;t worry. All this does is fill in the database information to a configuration file. You may also simply open <code>config-sample.php</code> in a text editor, fill in your information, and save it as <code>config.php</code>." ); ?></strong>
	<?php _e( "Need more help? <a href='http://codex.wordpress.org/Editing_config.php'>We got it</a>." ); ?>
</p>
...
<?php
	...
	if ( ! is_writable(ABSPATH) ) :
		setup_config_display_header();
?>
<p><?php _e( "Sorry, but I can&#8217;t write the <code>config.php</code> file." ); ?></p>
<p><?php _e( 'You can create the <code>config.php</code> manually and paste the following text into it.' ); ?></p>
