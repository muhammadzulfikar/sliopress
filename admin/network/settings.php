			...
			<tr>
				...
				<td>
					...
					<p class="description">
						...
						_e( 'If registration is disabled, please set <code>NOBLOGREDIRECT</code> in <code>config.php</code> to a URL you will redirect visitors to if they visit a non-existent site.' );
					?>
					</p>
				</td>
			</tr>
