...
get_current_screen()->add_help_tab( array(
	...
	'content' =>
		...
		'<p>' . __('<strong>Settings</strong> - This page shows a list of all settings associated with this site. Some are created by SlioPress and others are created by plugins you activate. Note that some fields are grayed out and say Serialized Data. You cannot modify these values due to the way the setting is stored in the database.') . '</p>'
) );
...
<form action="site-users.php?action=adduser" id="adduser" method="post">
	...
	<table class="form-table">
		<tr>
			...
			<td><input type="text" class="regular-text suggest-user" name="newuser" id="newuser" /></td>
		</tr>
		<tr>
