...
class T20_pinterest extends WP_Widget {
	...
	function widget($args, $instance){
		...
		<?php if( $instance['show_follow_button'] ){ ?>
			<div class="pin_follow"><a href="http://pinterest.com/<?php echo $instance['username'];?>/" target="_blank"><img src="http://passets-lt.pinterest.com/images/about/buttons/follow-me-on-pinterest-button.png" width="156" height="26" alt="Follow Me on Pinterest" /></a></div>
		<?php }	
		}		
		echo $after_widget;
	}
