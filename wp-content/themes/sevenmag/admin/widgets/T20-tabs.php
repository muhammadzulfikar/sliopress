...
class T20_Tabs extends WP_Widget {
	...
	private function _create_tabs($tabs,$count) {
		$titles = array(
			'recent'	=> __('Recent Posts','T20'),
			'popular'	=> __('Popular Posts','T20'),
			'comments'	=> __('Recent Comments','T20'),
			'tags'		=> __('Tags','T20')
		);
		$icons = array(
					...
					<div class="item_small">
						<div class="one_post">
							...
							<div class="item-details">
								...
								<div class="post_meta">
									<?php if($instance['tabs_date']) { ?><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title(); ?>"><i class="icon-calendar mi"></i><?php the_time('j M, Y'); ?></a>
