...
<?php endif; ?>
		...
		<div class="clearfix">
			<div class="alpha grid_3 widget_categories">
				<div class="b_title"><h4><?php _e('Last Posts', 'T20') ?></h4></div>
				<ol>
			...
			<div class="grid_9 mbs tagcloud">
				<div class="b_title"><h4><?php _e('Popular Tags', 'T20') ?></h4></div>
			...
			<div class="grid_3 widget_categories">
				<div class="b_title"><h4><?php _e('Categories', 'T20') ?></h4></div>
				<ul>
			...
			<div class="grid_3 widget_categories">
				<div class="b_title"><h4><?php _e('Monthly Archives', 'T20') ?></h4></div>
				<ul>
			...
			<div class="grid_3 omega widget_categories">
				<div class="b_title"><h4><?php _e('Pages', 'T20') ?></h4></div>
				<ul>
