...
class T20_social_widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<div class="social with_color">
			...
			<?php } if(!empty($cloud)){ ?>
				<a rel="nofollow" class="toptip" href="<?php echo $cloud; ?>" target="_blank" title="<?php _e( 'Follow us on Soundcloud', 'T20' ); ?>"><i class="fa fa-cloud"></i></a>
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['cloud'] = $new_instance['cloud'];
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'cloud' ); ?>"><?php _e('SoundCloud URL:', 'T20') ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'cloud' ); ?>" name="<?php echo $this->get_field_name( 'cloud' ); ?>" value="<?php echo $instance['cloud']; ?>" />
		</p>
