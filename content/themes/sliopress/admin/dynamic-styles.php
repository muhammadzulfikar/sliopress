...
#ajax-login-content-tab input[type="submit"]:hover, #ajax-login-user a:hover, #ajax-recaptcha-container a:hover, #submit:hover, #calendar #today, .tagcloud a:hover,
.search_icon i:hover, .pagenavi a, #footer #submit, #footer .search_btn, #footer .wpcf7-submit, .readmore:hover { background-color: '.ot_get_option('theme_color').' !important; }

.pagenavi a:hover {background: #1D1E20 !important;color: #fff}
