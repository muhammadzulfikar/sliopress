...
function pagenavi_textdomain() {
	load_plugin_textdomain('pagenavi', false, 'pagenavi');
}
...
/*function pagenavi_menu() {
	if (function_exists('add_menu_page')) {
		add_options_page(__('PageNavi', 'T20'), __('PageNavi', 'T20'), 'manage_options', 'pagenavi/pagenavi-options.php') ;
	}
}*/
...
function pagenavi_stylesheets() {
	if(@file_exists(get_template_directory().'/pagenavi-css.css')) {
		wp_enqueue_style('pagenavi', get_stylesheet_directory_uri().'/pagenavi-css.css', false, '2.50', 'all');
	} else {
		wp_enqueue_style('pagenavi', plugins_url('pagenavi/pagenavi-css.css'), false, '2.50', 'all');
	}
}
...
function pagenavi_init() {
	...
	$pagenavi_options['pages_text'] = __('Page','T20').' %CURRENT_PAGE% ' .__('of','T20').' %TOTAL_PAGES%';
	$pagenavi_options['current_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['page_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['first_text'] = __('&laquo; First','T20');
	$pagenavi_options['last_text'] = __('Last &raquo;','T20');
