	...
	class TGM_Plugin_Activation {
		...
		public function admin_init() {
			...
			if ( isset( $_REQUEST['tab'] ) && 'plugin-information' == $_REQUEST['tab'] ) {
				require_once ABSPATH . 'admin/includes/plugin-install.php'; // Need for install_plugin_information()
		...
		protected function do_plugin_install() {
			...
			if ( isset( $_GET[sanitize_key( 'plugin' )] ) && ( isset( $_GET[sanitize_key( 'tgmpa-install' )] ) && 'install-plugin' == $_GET[sanitize_key( 'tgmpa-install' )] ) ) {
				...
				if ( empty( $complete ) ) {
					...
					echo '<style type="text/css">#adminmenu .submenu li.current { display: none !important; }</style>';
				}
