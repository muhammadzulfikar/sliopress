...
<?php endif; ?>
		...
		<div class="b_block">
			<h1 class="mbt mt"><?php _e( 'Error 404 !', 'T20' ); ?></h1>
			<p><?php _e( 'The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.', 'T20' ); ?></p>
			<?php get_search_form(); ?>
		</div><!--/block-->
	</div><!--/grid-->
