...
function wp_review_tab_loadTabContent(tab_name, page_num, container, args_obj) {
    ...
    if (!isLoaded || page_num != 1) {
        if (!container.hasClass('review-tab-loading')) {
            container.addClass('review-tab-loading');
            ...
            tab_content.load(wp_review_tab.ajax_url, {
                    ...
                    container.removeClass('review-tab-loading');
...
jQuery(document).ready(function() {
    jQuery('.wp_review_tab_widget_content').each(function() {
        ...
        $this.find('.review-tabs a').click(function(e) {
            e.preventDefault();
        ...
        // pagination
        $this.on('click', '.review-tab-pagination a', function(e) {
            e.preventDefault();
        ...
        // load first tab now
        $this.find('.review-tabs a').first().click();
    });
