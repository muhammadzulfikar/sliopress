		...
		if ( is_user_logged_in() ) {
			...
			<div id="ajax-login-tabs">
				...
				<?php if ( $can_register && $show_registration ): ?> 
					<a class="ajax-login-tab" style="border-left: 1px solid #ccc; margin-left: -1px;" name="al-tab-registration" href="<?php echo esc_url( site_url( 'login.php?action=register' ) ); ?>" ><?php esc_html_e( 'Register' ) ?></a>
				<?php endif;?>
			...
			<div id="ajax-login-content-tab">
				...
				<div id="ajax-login-registration-form" class="ajax-login-form-wrap">
					...
					<form id="al-registration-form" action="<?php echo esc_url( site_url( 'login.php?action=register', 'login_post' ) ); ?>" method="post">
						<p>
						...
						<p>
							...
							<input type="hidden" name="url" value="<?php echo esc_url( site_url( 'login.php?action=register', 'login_post' ) ); ?>" />
				...
				<div id="ajax-login-lostpwd-form" class="ajax-login-form-wrap">
					...
					<form id="al-lostpwd-form" method="post" action="<?php echo site_url( 'login.php?action=lostpassword', 'login_post' ) ?>">
						<p>
				...
				<div id="ajax-login-login-form" class="ajax-login-form-wrap" style="display: block;">
					...
					<form id="al-login-form" action="<?php echo esc_url( site_url( 'login.php', 'login_post' ) ); ?>" method="post">
						<p>
						...
						<input type="submit" name="submit" class="submit-button" value="<?php esc_attr_e( 'Log In' ); ?>" tabindex="424">
					...
					<?php if ( $show_lostpwd ): ?>
						<a name="al-tab-lostpwd" href="<?php echo esc_url( site_url( 'login.php?action=lostpassword', 'login_post' ) ); ?>" title="<?php esc_attr_e( 'Lost your password?' ); ?>" tabindex="425" ><?php esc_html_e( 'Lost your password?' ) ?></a>
					<?php endif;?>
