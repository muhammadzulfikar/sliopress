...
<input type="text" name="captchac" class="tag ui-text-highlight code" readonly="readonly" onfocus="this.select()" />
<br />2) <?php echo esc_html( __( "For input field", 'contact-form-7' ) ); ?>
<input type="text" name="captchar" class="tag ui-text-highlight code" readonly="readonly" onfocus="this.select()" />
</div>
</form>
</div>
<?php
