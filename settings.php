...
require( ABSPATH . WPINC . '/class-error.php' );
...
require( ABSPATH . WPINC . '/class-theme.php' );
...
require( ABSPATH . WPINC . '/class-embed.php' );
...
if ( ! defined( 'WP_INSTALLING' ) || 'activate.php' === $pagenow ) {
