...
class WP_Rewrite {
	...
	public function rewrite_rules() {
		...
		$deprecated_files = array(
			'.*(atom|rdf|rss|rss2|feed|commentsrss2)\.php$' => $this->index . '?feed=old',
			'.*app\.php(/.*)?$' => $this->index . '?error=403',
		);
		...
		$registration_pages['.*register.php$'] = $this->index . '?register=true'; // Deprecated
