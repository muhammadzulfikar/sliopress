...
( function( $ ) {
	...
	wpLink = {
		...
		init: function() {
			...
			inputs.close.add( inputs.backdrop ).add( '#link-cancel a' ).click( function( event ) {
				event.preventDefault();
				wpLink.close();
			});

			$( '#link-search-toggle' ).on( 'click', wpLink.toggleInternalLinking );
	...
	River = function( element, search ) {
		...
		$( '#link .query-results, #link #link-selector' ).scroll( function() {
			self.maybeLoad();
		});
