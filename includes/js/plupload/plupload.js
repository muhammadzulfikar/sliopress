...
( function( exports, $ ) {
	...
	/**
	 * A SlioPress uploader.
	 *
	 * The Plupload library provides cross-browser uploader UI integration.
	 * This object bridges the Plupload API to integrate uploads into the
	 * SlioPress back-end and the SlioPress media experience.
	 *
	...
	Uploader = function( options ) {
		...
		this.uploader.bind( 'init', function( uploader ) {
			...
			dropzone.bind( 'dragover.uploader', function() {
				if ( timer ) {
					clearTimeout( timer );
				}
			...
			dropzone.bind('dragleave.uploader, drop.uploader', function() {
