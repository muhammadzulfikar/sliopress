...
wpList = {
	...
	process: function(el) {
		...
		$el.delegate( 'form[data-lists^="add:' + list.id + ':"]', 'submit', function(){
			return list.wpList.add(this);
		});

		$el.delegate( 'a[data-lists^="add:' + list.id + ':"], input[data-lists^="add:' + list.id + ':"]', 'click', function(){
			return list.wpList.add(this);
		});

		$el.delegate( '[data-lists^="delete:' + list.id + ':"]', 'click', function(){
			return list.wpList.del(this);
		});

		$el.delegate( '[data-lists^="dim:' + list.id + ':"]', 'click', function(){
