...
tinymce.PluginManager.add( 'wordpress', function( editor ) {
			...
			if ( e.content.indexOf( '<!--more' ) !== -1 ) {
				...
				e.content = e.content.replace( /<!--more(.*?)-->/g, function( match, moretext ) {
					return '<img src="' + tinymce.Env.transparentSrc + '" data-more="more" data-more-text="' + moretext + '" ' +
						'class="more-tag mce-more" title="' + title + '" data-mce-resize="false" data-mce-placeholder="1" />';
				});
			}
	...
	editor.addCommand( 'WP_Help', function() {
		editor.windowManager.open({
			url: tinymce.baseURL + '/mce-help.php',
	...
	function _setEmbed( c ) {
		return c.replace( /\[embed\]([\s\S]+?)\[\/embed\][\s\u00a0]*/g, function( a, b ) {
			return '<img width="300" height="200" src="' + tinymce.Env.transparentSrc + '" class="oembed" ' +
