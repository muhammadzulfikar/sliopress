...
tinymce.PluginManager.add( 'wpfullscreen', function( editor ) {
	...
	function fullscreenOn() {
		...
		editor.dom.addClass( editor.getDoc().documentElement, 'fullscreen' );
		// Start auto-resizing
	...
	function fullscreenOff() {
		...
		editor.dom.removeClass( editor.getDoc().documentElement, 'fullscreen' );
		// Stop auto-resizing
	...
	editor.addButton( 'wp_fullscreen', {
		...
		classes: 'fullscreen btn widget' // This overwrites all classes on the container!
	});
