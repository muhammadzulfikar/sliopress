...
/**
 * Adds a 'post-image' class to post thumbnails
...
function img_caption_shortcode( $attr, $content = null ) {
	...
	if ( current_theme_supports( 'html5', 'caption' ) ) {
		...
		. do_shortcode( $content ) . '<figcaption class="caption-text">' . $atts['caption'] . '</figcaption></figure>';
	}
	...
	. do_shortcode( $content ) . '<p class="caption-text">' . $atts['caption'] . '</p></div>';
}
...
<script type="text/html" id="tmpl-playlist-current-item">
	...
	<div class="playlist-caption">
		<span class="playlist-item-meta playlist-item-title">&#8220;{{ data.title }}&#8221;</span>
	...
	<div class="playlist-item">
		<a class="playlist-caption" href="{{ data.src }}">
			...
			<# if ( data.caption ) { #>
				{{ data.caption }}
			<# } else { #>
				<span class="playlist-item-title">&#8220;{{{ data.title }}}&#8221;</span>
...
<div class="playlist <?php echo $safe_type ?>-playlist playlist-<?php echo $safe_style ?>">
	...
	<script type="application/json" class="playlist-script"><?php echo wp_json_encode( $data ) ?></script>
</div>
	<?php
	return ob_get_clean();
}
...
/**
 * Return a filtered list of supported audio formats.
 *
 * @since 3.6.0
 * @return array
 */
...
function wp_audio_shortcode( $attr, $content = '' ) {
	 ...
	 */
	$html_atts = array(
		'class'    => apply_filters( 'wp_audio_shortcode_class', 'audio-shortcode' ),
...
/**
 * Return a filtered list of supported video formats
 *
 * @since 3.6.0
 * @return array
 */
...
function wp_video_shortcode( $attr, $content = '' ) {
	 ...
	 */
	$html_atts = array(
		'class'    => apply_filters( 'wp_video_shortcode_class', 'video-shortcode' ),
...
function _wp_image_editor_choose( $args = array() ) {
	require_once ABSPATH . WPINC . '/class-image-editor.php';
	require_once ABSPATH . WPINC . '/class-image-editor-gd.php';
	require_once ABSPATH . WPINC . '/class-image-editor-imagick.php';
...
function wp_plupload_default_settings() {
	...
	$data = $wp_scripts->get_data( 'plupload', 'data' );
	...
	$wp_scripts->add_data( 'plupload', 'data', $script );
}
...
function wpview_media_sandbox_styles() {
 	...
 	$wpmediaelement = includes_url( "js/mediaelement/mediaelement.css?$version" );
