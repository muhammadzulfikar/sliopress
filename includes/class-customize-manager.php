...
final class WP_Customize_Manager {
	...
	public function __construct() {
		require( ABSPATH . WPINC . '/class-customize-setting.php' );
		require( ABSPATH . WPINC . '/class-customize-panel.php' );
		require( ABSPATH . WPINC . '/class-customize-section.php' );
		require( ABSPATH . WPINC . '/class-customize-control.php' );
		require( ABSPATH . WPINC . '/class-customize-widgets.php' );
