<?php
/**
 * SlioPress Imagick Image Editor
 *
 * @package SlioPress
...
/**
 * SlioPress Image Editor Class for Image Manipulation through Imagick PHP Module
 *
 * @since 3.5.0
 * @package SlioPress
 * @subpackage Image_Editor
...
class WP_Image_Editor_Imagick extends WP_Image_Editor {
	...
	public function load() {
		...
		/** This filter is documented in includes/class-image-editor-imagick.php */
	...
	protected function _save( $image, $filename = null, $mime_type = null ) {
		...
		/** This filter is documented in includes/class-image-editor-gd.php */
		return array(
			'path'      => $filename,
