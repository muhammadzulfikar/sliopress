...
function wp_auth_check_html() {
	...
	<div id="auth-check">
	<div class="auth-check-close" tabindex="0" title="<?php esc_attr_e('Close'); ?>"></div>
	<?php

	if ( $same_domain ) {
		?>
		<div id="auth-check-form" data-src="<?php echo esc_url( add_query_arg( array( 'interim-login' => 1 ), $login_url ) ); ?>"></div>
		<?php
	}
 ...
 * @return array|object $response The Heartbeat response object or array with 'auth-check'
 *                                value set.
 */
